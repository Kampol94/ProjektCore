...
using ProjektCoreWTS__Universal_Windows_.Helpers;
using ProjektCoreWTS__Universal_Windows_.Services;
...
{
    public class KlienciMapViewModel : ViewModelBase
    {
